...
//     return (
//       <div className={cn('group relative z-0 w-full rounded-lg', className)}>
//         <Input
//           {...props}
//           ref={ref}
//           placeholder=" "
//           className={cn(
//             'peer block w-full appearance-none border-none bg-transparent px-5 pb-3 pt-7 text-sm text-text focus:ring-0'
//             // We move the border and background logic to the wrapper or pass it here
//           )}
//         />
//         <Label
//           className={cn(
//             'absolute left-5 top-5 z-10 origin-left -translate-y-4 scale-75 transform duration-300 pointer-events-none',
//             'peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:text-text/40',
